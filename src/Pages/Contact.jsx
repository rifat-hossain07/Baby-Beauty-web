    ...
    <div>
      ...
      <div className="hero md:min-h-screen">
        <div className="hero-content flex flex-col lg:flex-row  lg:gap-40">
          <div>
            <form className="border-2 border-blue-300 rounded-lg shadow-lg shadow-blue-300 bg-base-200">
          ...
          <div className="p-6 md:p-14 border-2 border-blue-300 rounded-lg shadow-lg shadow-blue-300 bg-base-200">
            <div data-aos="fade-down" data-aos-duration="2000">
